    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-calendar"></i> 表单配置 / 数据源管理</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div>数据源管理</div>
            <div class="table-wrapper">
                <el-input v-model="condition.keyword" placeholder="请输入关键字进行搜索" style="width: 500px;">
                    <el-button slot="append" icon="el-icon-search" type="primary" @click="selectDatabase">搜索</el-button>
                </el-input>
                <div class="table-fun">
                    <el-button type="primary" style="width: 80px;" @click="connnectDatabase"><i class="el-icon-sort"></i>  连接</el-button>
                    <el-button type="primary" style="width: 80px;" @click='addDatabaseclick'><i class="el-icon-lx-add"></i>  创建</el-button>
                    <!-- <el-button type="primary" style="width: 80px;" @click="editDatabase"><i class="el-icon-edit-outline"></i>  编辑</el-button> -->
                    <el-button type="primary" style="width: 80px;" @click='beforeDeleteDatabase'><i class="el-icon-circle-close"></i>  删除</el-button>
                </div>
                    ...
                    >
                      <template slot-scope="scope">
                        <el-button
                            size="mini"
                            type="primary"
                            @click="editDatabase(scope.$index, scope.row)">编辑</el-button>
                      </template>
                    </el-table-column>
                </el-table>
                <el-pagination
            ...
            <el-dialog
            :title="title"
            :visible.sync="showDatabaseAdd"
            :modal="true"
            width="400px"
            center>
                <el-form ref='form' :model="form" label-width="130px" label-position="left" :rules='formRules'>
            ...
            <el-dialog
                title='提示'
                :visible.sync="showDatabaseDelete"
                :modal="false"
                width="400px"
            >
...
import { addDatebase,getDatabasePage,deleteDatabase,contentdatabase } from "../../util/api.js";
