...
<div> 
  <div class="top">
      ...
      <div class="search">
              ...
              <el-input v-model="flow.name" style="width:250px"></el-input>

        </div>
  <div class="appcontainer">
     
    <div class="flow-menu">
      <div class="menu-item" v-for="item in menueList" draggable="true" :key="item.type" @dragstart="drag(item)">
        <i :class="item.icon"></i>
        <div>{{item.name}}</div>
      </div>
      <hr>
   ...
   <div class="bigboxright-button">
                    <el-button style="background-color: #1abc9c;width:100px;color: #fff;">暂存</el-button>
                    <el-button style="background-color: #1abc9c;width:100px;color: #fff;margin:0 25px 0 30px">提交</el-button>
                    <el-button style="width:100px;color:#a1a1a3">关闭</el-button>
 </div>
  </div>
</template>
