<template>
 <div class="editFlow">
    <!-- 新增流程 -->
    <el-form :model="flowData" v-if="parentPath!='flowdeclare'" ref="dataForm" label-width="100px" class="flowEditForm margin13" size="mini" style="padding:12px">
...
<!-- 新增授权 -->
<el-form :model="delegateData" v-if="parentPath =='flowdeclare'" ref="delegateData" label-width="100px" class="flowEditForm margin13" size="mini" style="padding:-12px">
<el-collapse v-model="activeName"  @change="changecollapse" >
  <el-collapse-item title="审批用户" name="1" @click.native="clickcollapse(name='1')" ref="collapseone">
    ...
    <div class="SPYH">
        ...
        <div class="SPYH_son">
            <div class="SPYH_box" style="border-right:1px solid #e7e7e7;color:#ffaf5a">处理层级</div>
            <div class="SPYH_box" >
                 <!-- <el-cascader
                    ...
                    <el-select v-model="delegateData.area" filterable placeholder="请选择" @change="changearea" >
                    <el-option
        ...
        <div class="SPYH_son">
            <div class="SPYH_box" style="border-right:1px solid #e7e7e7;color:#ffaf5a">授权用户</div>
            <div class="SPYH_box">
                <el-select v-model="delegateData.squser" filterable placeholder="请选择">
                    <el-option
        ...
        <div class="SPYH_son">
            <div class="SPYH_box" style="border-right:1px solid #e7e7e7;color:#ffaf5a">授权角色</div>
            <div class="SPYH_box">
                 <el-select v-model="delegateData.sqrole" filterable placeholder="请选择" >
                    <el-option
  ...
  <el-collapse-item title="审批表单" name="2" @click.native="clickcollapse(name='2')">
    <div></div>
    <div >
         <el-checkbox-group v-model="delegateData.from">
  ...
  <el-collapse-item title="审批材料" name="3" @click.native="clickcollapse(name='3')">
    <div>
        <el-checkbox-group v-model="delegateData.material">
  ...
  <el-collapse-item title="审批规则" name="4" @click.native="clickcollapse(name='4')">
   <div >
        <el-checkbox-group v-model="delegateData.rule">
   ...
   <el-collapse-item title="审批通知" name="6" @click.native="clickcollapse(name='6')">
    <div>
        <div class="radiobox">            
                <el-radio-group v-model="delegateData.notic_chufa" style="display:flex;flex-direction:column;justify-content：flex-start">
                   <el-radio v-for="(item, index) in notic_chufa_options" :label="item.name" :key="index" class="SPTZ_radio" style="line-height:45px"></el-radio>
                </el-radio-group>     
        </div>
...
<script>
    ...
    export default {
        ...
        //审批通知接手对象
          notic_user_options:[
             {name:"当前节点提交人",value:3},
             {name:"表单创建人",value:4},
             {name:"当前节点处理人",value:5},
         ],
        //审批用户提示
        tips:false,
        ...
        watch: {
                async current(news, olds){//放的是val的新旧变量
                    ...
                    // if(this.parentPath !=flowdefine)return
                    ...
                    //获取审批用户-关联关系                    
                    const SPyh = await post1(me, getspyh, {
                        'nodeid':news.nodeId
                    })
                    ...
                    //获取审批表单-关联关系
                    const SPbd = await post1(me, getspbdnode, {
                        'nodeid':news.nodeId
                    })
                    ...
                    //获取审批材料-关联关系
                    const SPcl = await post1(me, getspclnode, {
                        'nodeid':news.nodeId
                    })
                    ...
                    //获取审批规则-关联关系
                    const SPgz = await post1(me, getspgznode, {
                        'nodeid':news.nodeId
                    })
                    ...
                    //获取审批时间-关联关系
                    const SPsj = await post1(me, getspsxnode, {
                        'nodeid':news.nodeId
                    })
                    console.log("审批时间关联信息",SPsj)
                    this.delegateData.timeswitch=SPsj.data.isset=='1'?true:false
                    let  startdate=SPsj.data.startdate?SPsj.data.startdate:''
        ...
        methods: {
            ...
            async clickcollapse(name){
                ...
                if(name=="1" && this.delegateData.sqrole && this.delegateData.area && this.delegateData.squser){
                    ...
                    const res = await post(me,saveupdaetspbd , {
                        data:[
                            {
                                "zcformid":this.delegateData.from,
                                 "nodeid":currentid
                            }
                        ]
                    })
                ...
                //         data:[{
                //             "materialid":this.delegateData.material,
                //         }]
                //     })
                ...
                //     //保存节点审批时间
                //     const res = await post(me,saveupdatespsx , {
                //          "nodeid":currentid,
                //          "isset":this.delegateData.timeswitch,
                //          "endate":this.delegateData.time
                //     })
                // }else if(name=="6"){
                //     //审批通知
                // }
            ...
            this.parentPath =='flowdeclare'?this.getoption():''
